...
const DEFAULT_PATTERNS = ['**/*.js', '**/*.ts', '**/*.mjs', '**/*.ejs', '**/*.html', '**/*.css'];
const DEFAULT_IGNORE = ['node_modules/**', 'dist/**', 'build/**', 'summaries/**'];
...
async function processQueue() {
  ...
  console.clear();
  console.log(`🧠 ${ts} | ${files.length} checked | ${updated} summaries updated`);
  busy = false;
}
